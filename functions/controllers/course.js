...
export const getAllCourses = async(req, res) => {
    try {
        ...
        if (courses.length > 0) {
            courses.map((course) => {
                const bannerImageUrl = `https://main--heroic-rabanadas-aaaaaa.netlify.app/.netlify/functions/index/uploads/${course.title}_course`;
...
export const addcourse = async(req, res) => {
    ...
    try {
        ...
        if (req.file) {
            ...
            bannerImageUrl = `https://main--heroic-rabanadas-aaaaaa.netlify.app/.netlify/functions/index/uploads/${newFileName}`;
        }
...
export const addcontent = async(req, res) => {
    ...
    try {
        ...
        if (req.file) {
            ...
            req.file.filename = newFileName;
            req.file.path = newFilePath;
            const pdfUrl = `https://main--heroic-rabanadas-aaaaaa.netlify.app/.netlify/functions/index/uploads/${newFileName}`;
